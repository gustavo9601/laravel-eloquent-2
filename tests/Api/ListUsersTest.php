...
//    }
    ...
    function users_can_see_the_list_of_users_wrapped_in_data()
    {
        ...
        $this->actingAs($this->user, 'api'); // autentica con el usuario pasado en el prumero parametro

        $this->getJson('api/users')
            ->assertOk() // comprubea que ha cargado correctamente
            ->assertExactJson([  // verifica que tenga exactamente este Json
                'data' => [
                    [
                        'first_name' => 'John',
                        'last_name' => 'Doe',
...
//                'total' => 2,
    ...
    {
        $this->getJson('api/users')
            ->assertUnauthorized(); // debe obtener un error de autorizacion 401
    }
}
